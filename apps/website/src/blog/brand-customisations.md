...
![gurukulx-brand-customisations](https://assets.cdn.clsrio.com/blog/brand-customisations.png)
_GurukulX Brand Customisations_
...
Firstly let me quickly break down what we mean when we say _YOUR STUDENT DASHBOARD._ As an organisation or educator when you sign up on [gurukulx.com](https://gurukulx.com), you'd have to first create your organisation and then create your first course. This whole process is done within the admin dashboard - [app.gurukulx.com](https://app-gurukulx.vercel.app).

![gurukulx-courses-page](https://brand.cdn.clsrio.com/gurukulx-courses.png)
_The admin dashboard - app.gurukulx.com_
...
![gurukulx-lms-student-dashboard](https://brand.cdn.clsrio.com/gurukulx-lms-courses.png)
_The LMS aka Student dashboard - yourorg.gurukulx.com_

Typically this page can be found at _yourorg.gurukulx.com_, where _yourorg_ is a slug you set when you first set up your account. For example, we've built an internal bootcamp called GurukulX Developers, in this bootcamp we train other developers on some of the key tools we use internally. You can checkout our page here: [ciodevs.gurukulx.com](https://ciodevs.gurukulx.com), in this case you can see that our slug is _ciodevs_ and you should be able to easily see yours when you log into the dashboard `/org/{yourorg}`.
...
![gurukulx-customise-brand-color](https://brand.cdn.clsrio.com/customise-brand-color.png)
...
Thank you very much for reading till the end, I know this was a lot 😅. Please give this update a try and let us know what you think about it on [X](https://x.com/gurukulx).
