...
imageUrl: 'https://assets.cdn.clsrio.com/blog/google-os-peer-bonus-gurukulx.png'
date: '2024-05-25'
author: Rotimi Best
...
![best](/blog/google-os-peer-bonus-gurukulx.png)
...
After I made [GurukulX](https://git.new/class) open source, a lot of people helped us get traction from the community and soon enough we got noticed by several educators in the community.
...
I want to use this opportunity to thank [Ada Nduka Oyom](https://x.com/Kolokodess) for reaching out to me and recommending [GurukulX](https://git.new/class) internally at Google to receive the Google Open Source Peer Bonus.
