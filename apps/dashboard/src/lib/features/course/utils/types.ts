...
// List lessons types
export type ListLessonsRequest = (typeof gurukulx.course)[':courseId']['lesson']['$get'];
...
// Get lesson types
export type GetLessonRequest = (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['$get'];
...
// Create lesson types
export type CreateLessonRequest = (typeof gurukulx.course)[':courseId']['lesson']['$post'];
...
// Update lesson types
export type UpdateLessonRequest = (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['$put'];
...
// Delete lesson types
export type DeleteLessonRequest = (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['$delete'];
...
export type CreateCourseSectionRequest = (typeof gurukulx.course)[':courseId']['section']['$post'];
...
export type UpdateCourseSectionRequest = (typeof gurukulx.course)[':courseId']['section'][':sectionId']['$put'];
...
export type DeleteCourseSectionRequest = (typeof gurukulx.course)[':courseId']['section'][':sectionId']['$delete'];
...
export type ReorderCourseSectionsRequest = (typeof gurukulx.course)[':courseId']['section']['reorder']['$post'];
...
export type PromoteUngroupedSectionRequest =
  (typeof gurukulx.course)[':courseId']['section']['promote-ungrouped']['$post'];
...
export type ReorderLessonsRequest = (typeof gurukulx.course)[':courseId']['lesson']['reorder']['$post'];
...
export type GetLessonCommentsRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['comment']['$get'];
...
export type CreateLessonCommentRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['comment']['$post'];
...
export type DeleteLessonCommentRequest =
  (typeof gurukulx.course)[':courseId']['lesson']['comment'][':commentId']['$delete'];
...
export type UpdateLessonCommentRequest =
  (typeof gurukulx.course)[':courseId']['lesson']['comment'][':commentId']['$put'];
...
export type CreatePaymentRequestRequest = (typeof gurukulx.course)[':courseId']['payment-request']['$post'];
...
export type GetLessonCompletionRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['completion']['$get'];
...
export type UpdateLessonCompletionRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['completion']['$put'];
...
export type GetLessonHistoryRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['history']['$get'];
...
export type GetLessonLanguageRequest =
  (typeof gurukulx.course)[':courseId']['lesson'][':lessonId']['language']['$get'];
...
// Exercise types
export type GetExerciseRequest = (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['$get'];
...
export type CreateExerciseRequest = (typeof gurukulx.course)[':courseId']['exercise']['$post'];
export type CreateExerciseFromTemplateRequest =
  (typeof gurukulx.course)[':courseId']['exercise']['from-template']['$post'];
...
export type UpdateExerciseRequest = (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['$put'];
export type DeleteExerciseRequest = (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['$delete'];
export type SubmitExerciseRequest =
  (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['submission']['$post'];

// Newsfeed types
export type ListNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed']['$get'];
...
export type GetNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['$get'];
export type CreateNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed']['$post'];
export type UpdateNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['$put'];

export type ReactToNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['react']['$put'];
...
export type DeleteNewsfeedRequest = (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['$delete'];
export type GetNewsfeedCommentsRequest =
  (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['comments']['$get'];
...
export type CreateNewsfeedCommentRequest =
  (typeof gurukulx.course)[':courseId']['newsfeed'][':feedId']['comment']['$post'];
export type UpdateNewsfeedCommentRequest =
  (typeof gurukulx.course)[':courseId']['newsfeed']['comment'][':commentId']['$put'];
export type DeleteNewsfeedCommentRequest =
  (typeof gurukulx.course)[':courseId']['newsfeed']['comment'][':commentId']['$delete'];
...
export type UpsertAttendanceRequest = (typeof gurukulx.course)[':courseId']['attendance']['$post'];

// Mark types
export type GetMarksRequest = (typeof gurukulx.course)[':courseId']['mark']['$get'];
...
export type ListExerciseSubmissionsRequest =
  (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['submissions']['$get'];
...
export type ListSubmissionsForGradingRequest =
  (typeof gurukulx.course)[':courseId']['submission']['for-grading']['$get'];
...
export type UpdateSubmissionRequest = (typeof gurukulx.course)[':courseId']['submission'][':submissionId']['$put'];
export type DeleteSubmissionRequest =
  (typeof gurukulx.course)[':courseId']['submission'][':submissionId']['$delete'];
export type UpdateSubmissionAnswerRequest =
  (typeof gurukulx.course)[':courseId']['submission'][':submissionId']['answer']['$put'];
export type UpdateSubmissionGradesRequest =
  (typeof gurukulx.course)[':courseId']['submission'][':submissionId']['grades']['$put'];

// Course types
export type CreateCourseRequest = typeof gurukulx.course.$post;
export type GetCourseRequest = (typeof gurukulx.course)[':courseId']['$get'];
export type GetCourseBySlugRequest = (typeof gurukulx.course)['slug'][':slug']['$get'];
...
export type UpdateCourseRequest = (typeof gurukulx.course)[':courseId']['$put'];
export type DeleteCourseRequest = (typeof gurukulx.course)[':courseId']['$delete'];
export type UpdateCourseContentRequest = (typeof gurukulx.course)[':courseId']['content']['$put'];
export type DeleteCourseContentRequest = (typeof gurukulx.course)[':courseId']['content']['$delete'];
export type GetCourseProgressRequest = (typeof gurukulx.course)[':courseId']['progress']['$get'];
export type GetCertificationEvaluationRequest =
  (typeof gurukulx.course)[':courseId']['certification-evaluation']['$get'];
...
export type CloneCourseRequest = (typeof gurukulx.course)[':courseId']['clone']['$post'];
export type EnrollCourseRequest = (typeof gurukulx.course)[':courseId']['enroll']['$post'];
...
export type ListPeopleRequest = (typeof gurukulx.course)[':courseId']['members']['$get'];
...
export type AddPeopleRequest = (typeof gurukulx.course)[':courseId']['members']['$post'];
...
export type CreateStudentInviteRequest = (typeof gurukulx.course)[':courseId']['invites']['$post'];
...
export type ListStudentInvitesRequest = (typeof gurukulx.course)[':courseId']['invites']['$get'];
...
export type RevokeStudentInviteRequest =
  (typeof gurukulx.course)[':courseId']['invites'][':inviteId']['revoke']['$post'];
...
export type GetStudentInviteAuditRequest =
  (typeof gurukulx.course)[':courseId']['invites'][':inviteId']['audit']['$get'];
...
export type UpdatePeopleRequest = (typeof gurukulx.course)[':courseId']['members'][':memberId']['$put'];
...
export type DeletePeopleRequest = (typeof gurukulx.course)[':courseId']['members'][':memberId']['$delete'];
...
export type GetUserCourseAnalyticsRequest =
  (typeof gurukulx.course)[':courseId']['members'][':userId']['analytics']['$get'];
...
export type GetCourseAnalyticsRequest = (typeof gurukulx.course)[':courseId']['analytics']['$get'];
...
export type GetCourseComplianceOverviewRequest = (typeof gurukulx.course)[':courseId']['compliance']['$get'];
...
export type GetLearnerComplianceHistoryRequest =
  (typeof gurukulx.course)[':courseId']['compliance']['learners'][':profileId']['$get'];
...
export type ResetCourseComplianceRequest = (typeof gurukulx.course)[':courseId']['compliance']['reset']['$post'];
...
export type ExtendCourseComplianceRequest = (typeof gurukulx.course)[':courseId']['compliance']['extend']['$post'];
...
export type WaiveCourseComplianceRequest = (typeof gurukulx.course)[':courseId']['compliance']['waive']['$post'];
...
export type GetAllTemplatesMetadataRequest = (typeof gurukulx.course)[':courseId']['exercise']['template']['$get'];
...
export type GetTemplateByTagRequest =
  (typeof gurukulx.course)[':courseId']['exercise']['template']['tag'][':tag']['$get'];
...
export type GetTemplateByIdRequest = (typeof gurukulx.course)[':courseId']['exercise']['template'][':id']['$get'];
...
// Presign types
export type DocumentUploadPresignRequest = (typeof gurukulx.course)['presign']['document']['upload']['$post'];
export type DocumentUploadPresignSuccess = Extract<InferResponseType<DocumentUploadPresignRequest>, { success: true }>;

export type DocumentDownloadPresignRequest = (typeof gurukulx.course)['presign']['document']['download']['$post'];
export type DocumentDownloadPresignSuccess = Extract<
  InferResponseType<DocumentDownloadPresignRequest>,
  { success: true }
>;

export type VideoUploadPresignRequest = (typeof gurukulx.course)['presign']['video']['upload']['$post'];
export type VideoUploadPresignSuccess = Extract<InferResponseType<VideoUploadPresignRequest>, { success: true }>;

export type VideoDownloadPresignRequest = (typeof gurukulx.course)['presign']['video']['download']['$post'];
...
export type VideoRecordingUploadInitRequest =
  (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['question'][':questionId']['video-recording']['upload']['init']['$post'];
export type VideoRecordingUploadCompleteRequest =
  (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['question'][':questionId']['video-recording']['upload']['complete']['$post'];
export type VideoRecordingPlaybackRequest =
  (typeof gurukulx.course)[':courseId']['exercise'][':exerciseId']['submission'][':submissionId']['question'][':questionId']['video-recording']['playback']['$get'];
