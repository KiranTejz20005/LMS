...
// Org Courses types
export type GetOrgCoursesRequest = typeof gurukulx.organization.courses.$get;
...
export type GetUserEnrolledCoursesRequest = typeof gurukulx.organization.courses.enrolled.$get;
...
export type GetRecommendedCoursesRequest = typeof gurukulx.organization.courses.recommended.$get;
